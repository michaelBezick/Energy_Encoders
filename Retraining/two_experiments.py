...
temp_second = BVAE.load_from_checkpoint(
...
energy_matching_model = BVAE.load_from_checkpoint(
...
correlational_model = third_degree_model
correlational_model.energy_fn = second_degree_model.energy_fn
...
for (model, model_name) in model_list:
    for total_experiment_number in range(num_overall_experiments_to_run):
        for experiment_number, energy_loss_fn in enumerate(energy_loss_function_list):
            ...
            with open(f"./Multiple_Runs_Comparison_hist/{model_name}_{experiment_name}_{total_experiment_number}_experiment_num_training_info.pkl", "wb") as file:
