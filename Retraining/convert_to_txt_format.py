...
second = torch.load("./highest_FOM_images_2_degree.pt").to(torch.uint8).flatten(start_dim=2, end_dim=3).squeeze()
third = torch.load("./highest_FOM_images_3_degree.pt").to(torch.uint8).flatten(start_dim=2, end_dim=3).squeeze()
fourth = torch.load("./highest_FOM_images_4_degree.pt").to(torch.uint8).flatten(start_dim=2, end_dim=3).squeeze()
