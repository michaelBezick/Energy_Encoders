...
from Modules.Energy_Encoder_Modules import AttnBlock, VGGPerceptualLoss, ResnetBlockVAE
...
class BVAE(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        """"""
        transitioned_vectors_with_gradient = self.scale_vector_copy_gradient(transitioned_vectors.type(torch.int8), probabilities)
        """"""
